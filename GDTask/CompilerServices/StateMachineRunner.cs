...
namespace Fractural.Tasks.CompilerServices
{
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        {
            if (!pool.TryPop(out AsyncGDTaskVoid<TStateMachine> result))
            {
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        {
            if (!pool.TryPop(out AsyncGDTask<TStateMachine> result))
            {
        ...
        where TStateMachine : IAsyncStateMachine
    {
        ...
        {
            if (!pool.TryPop(out AsyncGDTask<TStateMachine, T> result))
            {
